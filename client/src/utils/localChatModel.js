import qaDatabase from '../data/qaDatabase.json';

/**
 * 키워드 기반 질문 매칭 및 답변 생성 (클라이언트 버전)
 */
class LocalChatModel {
  ...
  async processMessage(userMessage, context = {}) {
    ...
    // 3. 검색 의도 확인
    const searchKeywords = ['검색', '찾아', '찾아줘', '찾아봐', '찾기', '보여줘', '보여', '알려줘', '알려', '추천', '추천해줘', 'search', 'find', 'show', 'recommend', '있어', '있나', '있을까'];
...
export default new LocalChatModel();
