 ...
 * @param {Array} proposedActions
 * @param {Object} userContext
 * @returns {{verdict: string, reason: string, violatedPolicies?: Array, alternativeGuidance?: string}}
 */
function checkPolicySafety(message, proposedActions, userContext) {
